...
class FPSSimplePosition {
public:
  FPSSimplePosition() = default;

  FPSSimplePosition(glm::vec3 position, float yaw, float pitch, float roll, glm::vec3 scale = glm::vec3{1.0F, 1.0F, 1.0F})
