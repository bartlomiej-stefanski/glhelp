...
public:
  ...
  {
    return std::make_shared< MovingSpotLight< PositionSource > >(std::move(position_source), color, linear_coeff, quadratic_coeff, cutoff, outer_cutoff);
  }
